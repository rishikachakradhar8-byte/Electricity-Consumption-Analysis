...
## Dashboard Embedding with Flask

The Tableau dashboard is embedded into a simple Flask web application to display the visualization in a web interface.

Steps followed:

1. Installed Flask using:
   pip install flask

2. Created a Flask application (app.py).

3. Defined a route `/dashboard` to render the Tableau dashboard.

4. Embedded the Tableau Public dashboard using an iframe.
